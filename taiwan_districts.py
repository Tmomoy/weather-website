...
for d in taipei:
    district_city_map[d] = "臺北市"

new_taipei = ["板橋區","三重區","中和區","永和區","新莊區","新店區","土城區","蘆洲區"]
for d in new_taipei:
    district_city_map[d] = "新北市"

taoyuan = ["桃園區","中壢區","平鎮區","八德區"]
for d in taoyuan:
    district_city_map[d] = "桃園市"

taichung = ["西屯區","北屯區","南屯區"]
for d in taichung:
    district_city_map[d] = "臺中市"

tainan = ["永康區"]
for d in tainan:
    district_city_map[d] = "臺南市"

kaohsiung = ["三民區","左營區","楠梓區","鳳山區"]
for d in kaohsiung:
    district_city_map[d] = "高雄市"

yilan = ["羅東鎮"]
for d in yilan:
    district_city_map[d] = "宜蘭縣"

pingtung = ["潮州鎮"]
for d in pingtung:
    district_city_map[d] = "屏東縣"

hualien = ["花蓮市"]
for d in hualien:
    district_city_map[d] = "花蓮縣"

taitung = ["台東市"]
for d in taitung:
    district_city_map[d] = "臺東縣"