...
for d in districts:
    ...
    if d.endswith("區") or d.endswith("市"):

        if "台北" in d:
            district_city_map[d] = "Taipei"

        elif "新北" in d:
            district_city_map[d] = "New Taipei"

        elif "桃園" in d:
            district_city_map[d] = "Taoyuan"

    # 其他預設
    district_city_map[d] = d